...
<h3 className="text-2xl font-semibold flex items-center gap-3">About Me <a href="/MYRESUME.pdf" target="_blank" rel="noreferrer" className="px-3 py-1 border rounded-md text-sm bg-gradient-to-r from-yellow-300 to-yellow-400 text-black">Resume</a></h3> 
